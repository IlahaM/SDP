...
rf = RandomForestClassifier(n_estimators=100, max_depth=200, n_jobs=-1, random_state=0)
...
classifier = OneVsRestClassifier(RandomForestClassifier(n_estimators=100, max_depth=200, n_jobs=-1, random_state=0))
